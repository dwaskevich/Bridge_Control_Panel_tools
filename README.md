# Bridge_Control_Panel_tools
Tools to enable secondary EZI2C interface for Bridge Control Panel use.

Sample of main.c to replicate CapSense Tuner-like charting in Bridge Control Panel (raw, baseline, diff).

Based on https://github.com/Infineon/mtb-example-psoc4-capsense-csd-button-tuning code example for CY8CKIT-149 kit.
...
int main(void)
{
    ...
    for (;;)
    {
        if(CY_CAPSENSE_NOT_BUSY == Cy_CapSense_IsBusy(&cy_capsense_context))
        {
            ...
            {
                RegisterMap.sensor_raw_count[CY_CAPSENSE_BUTTON0_WDGT_ID] = CY_CAPSENSE_BUTTON0_SNS0_RAW0_VALUE;
                RegisterMap.bsln[CY_CAPSENSE_BUTTON0_WDGT_ID] = CY_CAPSENSE_BUTTON0_SNS0_BSLN0_VALUE;
                RegisterMap.diff[CY_CAPSENSE_BUTTON0_WDGT_ID] = CY_CAPSENSE_BUTTON0_SNS0_DIFF0_VALUE;
